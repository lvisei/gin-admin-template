...
import (
	...
	loggerhook "gin-admin-template/pkg/logger/hook"
	loggergormhook "gin-admin-template/pkg/logger/hook/gorm"
	loggermongohook "gin-admin-template/pkg/logger/hook/mongo"
