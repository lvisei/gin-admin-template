...
// @Success 200 {object} schema.ListResult{list=[]schema.Menu} "查询结果：{list:列表数据,pagination:{current:页索引,pageSize:页大小,total:总数量}}"
...
// @Summary 创建数据
// @Security ApiKeyAuth
// @Param body body schema.MenuCreateParams true "创建数据"
...
// @Security ApiKeyAuth
// @Param id path string true "唯一标识"
// @Param body body schema.MenuCreateParams true "更新数据"
